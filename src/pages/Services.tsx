      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground font-body mt-4 max-w-lg mx-auto">
            Lashes, brows & makeup at fair prices. All services include prep & finishing touches.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-card rounded-2xl border border-border/50 shadow-soft p-8 space-y-4">
            ...
            <p className="text-center font-body text-sm text-muted-foreground">
              Contact: <a href={data?.settings.phoneHref || "tel:+27719843649"} className="text-primary font-bold">{data?.settings.phoneDisplay || "071 984 3649"}</a>
            </p>
          </div>
        </motion.div>
