      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
            { icon: Sparkles, title: "Acrylic / Polygel Nails", price: "", desc: "Short, medium or long sets — sculpted to perfection" },
              { icon: Heart, title: "Lash Extensions", price: "from R50", desc: "Classic, cat-eye and volume lash sets" },
