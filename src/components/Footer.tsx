...
const Footer = () => {
  ...
  const wa = s?.whatsappNumber || "27719843649";
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href={s?.phoneHref || "tel:+27719843649"} className="text-sm text-muted-foreground hover:text-primary font-body">
              {s?.phoneDisplay || "071 984 3649"}
            </a>
            <a
        ...
        <p className="text-center text-xs text-muted-foreground font-body mt-8">
          © 2026 Kim's Glam Lab — Lashes • Brows • Makeup. All rights reserved.
        </p>
      </div>
    </footer>
  );
